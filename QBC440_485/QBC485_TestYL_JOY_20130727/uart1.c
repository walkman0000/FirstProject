...
//	 T1_Send_Buffer[12]=7; //40664L//AFC运输机正常停止命令
//	 T1_Send_Buffer[13]=0; //40665H
//	 T1_Send_Buffer[14]=NeedChangeCMD1; //40665L//BSL刮板机正常停止命令
//	 T1_Send_Buffer[15]=0; //40665H
//	 T1_Send_Buffer[16]=QBCReadBuff[2]; //40665L//BSL刮板机正常停止命令
//	 T1_Send_Buffer[17]=0; //40665H
//	 T1_Send_Buffer[18]=QBCReadBuff[3]; //40665L//BSL刮板机正常停止命令
...
//	 T1_Send_Buffer[20]=CRC16(T1_Send_Buffer,19,0);
	 ...
	 T1_Send_Buffer[4]=QBCReadBuff[1]; //40665L//BSL刮板机正常停止命令
	 T1_Send_Buffer[5]=(switchToAFC_heartBeat>>8);//40660H
	 T1_Send_Buffer[6]=switchToAFC_heartBeat;//40660L
	 T1_Send_Buffer[7]=0; //40665H
	 T1_Send_Buffer[8]=QBCReadBuff[2]; //40665L//BSL刮板机正常停止命令
	 T1_Send_Buffer[9]=0; //40665H
	 T1_Send_Buffer[10]=QBCReadBuff[3]; //40665L//BSL刮板机正常停止命令
